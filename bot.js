...
setInterval(() => {
let değerler =["d!yardım | d!botbilgi",  `${client.guilds.cache.size} Sunucu ve ${client.guilds.cache.reduce((a, b) => a + b.memberCount, 0).toLocaleString()} Kullanıcıya Hizmet Veriyorum!`];
...
<a:EnesAcar47:825383896040341504> **Selamlar, Ben Sefa (Dersus'ın Geliştiricisi) Botumuzu Eklediğiniz ve Bize Destek Olduğunuz İçin Teşekkürler.**

**Dersus Botun Prefixi(ön eki) = d!**

\`Nasıl Kullanılır?\`
**Dersus Botun Tüm Özelliklerinden Yararlanabilmek İçin Sadece d!yardım Yazmanız Yeterlidir.**

**Linklerim;** \n [Beni Sunucuna Ekle](https://discord.com/api/oauth2/authorize?client_id=822075617092304926&permissions=8&scope=bot) \n [Destek Sunucum](https://discord.gg/BpCGmuFTR8)
`)
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('805011491584606228').send(plasmic);
...
.addField("Sunucudaki Kişi Sayısı:", guild.memberCount)
   ...
   client.channels.cache.get('825436186780500068').send(plasmicc);
...
//ses
client.on("ready", async () => { 
let botVoiceChannel = client.channels.cache.get("824015109985665024"); 
if (botVoiceChannel) 
