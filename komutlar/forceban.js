           ...
           .then(bans => {
               ...
               message.guild.members.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> adlı kullanıcı banlandı <a:B_Banned:825383310342619136>`);
                   })
                   .catch(error => {
           ...
           .then(bans => {
               ...
               message.guild.ban(seyfooo, sebeb)
                   .then(async (member) => {
                       ...
                       message.channel.send(`<@!${user.id}> sunucudan yasaklandı <a:B_Banned:825383310342619136>`);
                   })
                   .catch(error => {
